...
This project uses **mise** for runtime version management. Elixir and Erlang are not on PATH directly.

Run all mix commands through mise:
...
<!-- Auto-generated by /phx:init | 2026-06-01 | Phoenix not detected, Ecto not detected (pure Elixir library) -->
...
Offer `mise exec -- mix test` after significant changes.
